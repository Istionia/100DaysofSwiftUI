...
//  WeSplit
//
//  Created by Timothy on 06/09/2022.
//
        ...
        NavigationView {
            Form {
                ...
                Section {
                    ...
                    Text("Service tax charge/desired tip percentage")
                }
                
                Section {
                    Text(originalAmount, format: currencyFormatter)
                ...
                Section {
                    ...
                    Text("Total check/receipt amount")
                }
